...
[CollectionBuilder(typeof(LineDashSequence), nameof(Create))]
public readonly partial struct LineDashSequence : IEnumerable<float>
{
	...
	/// </summary>
	public ReadOnlySpan<float> Intervals => CollectionsMarshal.AsSpan(_intervals);
	...
	public static implicit operator SKPathEffect(LineDashSequence sequence) => SKPathEffect.CreateDash([.. sequence._intervals], 0);
}
