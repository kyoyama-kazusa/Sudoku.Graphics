...
[JsonDerivedType(typeof(CandidatePairBezierLineMarkItem), nameof(CandidatePairBezierLineMarkItem))]
[JsonDerivedType(typeof(CandidatePairLineMarkItem), nameof(CandidatePairLineMarkItem))]
...
[JsonDerivedType(typeof(CellBisectorLineMarkItem), nameof(CellBisectorLineMarkItem))]
...
[JsonDerivedType(typeof(CellGroupKillerCageMarkItem), nameof(CellGroupKillerCageMarkItem))]
[JsonDerivedType(typeof(CellGroupTrailedCapsuleArrowMarkItem), nameof(CellGroupTrailedCapsuleArrowMarkItem))]
[JsonDerivedType(typeof(CellGroupTrailedCapsuleSatelliteMarkItem), nameof(CellGroupTrailedCapsuleSatelliteMarkItem))]
