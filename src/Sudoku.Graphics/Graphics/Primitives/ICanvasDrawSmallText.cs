...
public interface ICanvasDrawSmallText
{
	...
	/// <param name="innerSize">The number of inner rows and columns.</param>
	/// <param name="color">The color.</param>
	/// <param name="slant">The text slant.</param>
	void DrawSmallText(string text, Relative cell, int innerPosition, int innerSize, SKColor color, SKFontStyleSlant slant);
	...
	/// <param name="color">The color.</param>
	/// <param name="slant">The text slant.</param>
	void DrawSmallText(string text, Absolute cell, int innerPosition, int innerSize, SKColor color, SKFontStyleSlant slant);
}
