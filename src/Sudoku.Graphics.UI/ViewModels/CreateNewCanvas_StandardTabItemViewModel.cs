...
internal sealed partial class CreateNewCanvas_StandardTabItemViewModel : CreateNewCanvas_TabItemViewModel
{
	public CreateNewCanvas_StandardTabItemViewModel() => CalculateSize();


	/// <inheritdoc/>
	public override string Title => LocalizationResources.CreateNewCanvasWindow_TabPage_Standard;
	...
	/// <inheritdoc/>
	public override StandardCreateNewCanvasWindowResult? GetResult()
	{
